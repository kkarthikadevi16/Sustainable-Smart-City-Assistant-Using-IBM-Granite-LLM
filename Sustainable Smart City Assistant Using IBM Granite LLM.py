...
Original file is located at
    https://colab.research.google.com/drive/1ooKz5cKrsJbXw9efhjGqBrARcM2f6Pc6
"""
...
def policy_summarization(pdf_file, policy_text):
  ...
  if pdf_file is not None:
    ...
    return "Please provide either a PDF file or paste the policy text."
  ...
  with gr.Tabs():
    ...
    with gr.TabItem("Policy Summarization"):
      with gr.Row():
        ...
        with gr.Column():
          summary_output = gr.Textbox(label="Policy Summary & Key Points", lines=28)
